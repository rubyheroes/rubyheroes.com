...
set :repository, 'http://svn.rubyheroes.beanstalkapp.com/rubyheroes/trunk' # Set here your repository! Example: 'https://dev.morphexchange.com/repos/ruby/trunk/control_panel/control_panel'
  ...
  task :update_code do
    transaction do
      ...
      conn_start do |http|
        ...
        add_mex_fields(r) 
        r.add_field('morph-version-name', Time.now.utc.strftime('%Y-%m%-%d %H:%M:%S'))
