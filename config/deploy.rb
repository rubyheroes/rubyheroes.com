...
# the application.
set :application, "rubyheroes"

# Target directory for the application on the web and app servers.
set :deploy_to, "/var/www/apps/#{application}"

# Primary domain name of your application. Used as a default for all server roles.
set :domain, "beta.rubyheroes.com"

# Login user for ssh.
set :user, "deploy"

# URL of your source repository.
set :repository, "http://svn.rubyheroes.beanstalkapp.com/rubyheroes/"
set :svn_username, "patched"
set :svn_password, "different"
